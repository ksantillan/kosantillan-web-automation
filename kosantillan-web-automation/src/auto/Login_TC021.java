...
public class Login_TC021 {
	...
	@Test
	public static void LOGIN_TC021_App_Store_Links(@Optional("chrome") String browser, @Optional("SG") String activesite, @Optional("Test") String activeenvironment) throws Exception {

		Constant.browser = browser;	
		logger = Reporter.PrepareReport(activesite+" LOGIN TC021 App Store Links");
		...
		DoThis.click(LoginPage.hrfAppStore, "Y");
		...
		if(!DoThis.isObjectDisplayed(AppStoreCartrack.hdrCartrackApp, "Apple Store Cartrack App", "Y"))  {assertTrue(false);}
