...
public class Login_TC015 {
	...
	@Test
	public static void LOGIN_TC015_SignUp_Page(@Optional("chrome") String browser, @Optional("SG") String activesite, @Optional("Test") String activeenvironment) throws Exception {

		Constant.browser = browser;	
		logger = Reporter.PrepareReport(activesite+" LOGIN TC015 SignUp Page");

		LaunchBrowser.Execute(browser, activesite, activeenvironment, true, true); 
		
		Dictionary SignUpDetails = new Hashtable();
		SignUpDetails.put("signup_type", "Business");
		SignUpDetails.put("signup_business_name", "Automation Business");
		SignUpDetails.put("signup_company_name", "ABC Company");
		SignUpDetails.put("signup_email", "edmundo.delacruz@cartrack.com");
		SignUpDetails.put("signup_country", "Singapore");
		SignUpDetails.put("signup_phone", "88233070");
		SignUpDetails.put("signup_number_of_vehicles", "3");
